...
class Astronomy {
    public static void Main() {
        // (string name, double orbitalRadius, double radius, double orbitalPeriod, double rotationalPeriod, string color, SpaceObject orbits = null)
        ...
        while (!found) {
            ...
            foreach (SpaceObject x in solarSystem) { 
                    ...
                    found = true;
                    x.Draw();
                    Console.WriteLine($"Position after {days} days: {x.getPosition(days)}");
                    ...
                    satellites.ForEach((sat) => {
                        sat.Draw();
                        Console.WriteLine($"Position after {days} days: {sat.getPosition(days)}");
                    });
                    break;
                }
            };
